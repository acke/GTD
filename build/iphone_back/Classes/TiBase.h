...
// in simulator we redefine to format for GTD Developer console
...
{\
	NSString * exceptionName = [@"org.gtd." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gtd";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIGTDNativeItemNone = -1, 
	UIGTDNativeItemSpinner = -2,
	UIGTDNativeItemProgressBar = -3,
	
	UIGTDNativeItemSlider = -4,
	UIGTDNativeItemSwitch = -5,
	UIGTDNativeItemMultiButton = -6,
	UIGTDNativeItemSegmented = -7,
	
	UIGTDNativeItemTextView = -8,
	UIGTDNativeItemTextField = -9,
	UIGTDNativeItemSearchBar = -10,
	
	UIGTDNativeItemPicker = -11,
	UIGTDNativeItemDatePicker = -12,
	
	UIGTDNativeItemInfoLight = -13,
	UIGTDNativeItemInfoDark = -14,
	
	UIGTDNativeItemDisclosure = -15,
	
	UIGTDNativeItemContactAdd = -16
};
